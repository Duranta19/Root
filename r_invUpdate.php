...
include('components/dbConnect.php');
    ...
    $rID = $_GET['rid'];
    $error = false;
    $sql1 = "select * from retailer where r_sl = $serial and id= $rID";
    ...
    if(isset($_POST['update'])){
        ...
        $pprice = $_POST['price'];
        include('components/dbConnect.php');
        $sql = "UPDATE `retailer` SET `selling_price` = $pprice WHERE `retailer`.`r_sl` = $serial and `retailer`.`id` = $rID;";
...
<body class="header">
    ...
    <div class="container w-50">
        <form action="r_invUpdate.php?rsl= <?php echo $serial ?> & rid=<?php echo $rID ?>" method="POST">
            <div class="Container">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <a href="r_inventory.php?rid=<?php echo $rID?>" class="btn mt-4" style="background-color:aliceblue">Cancle</a>
                </div>
            </div>>
        </form>
    </div>
