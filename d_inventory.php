...
<body class="header">
  ...
  <nav class="navbar navbar-expand-lg navbar-light " >
        ...
        <a class="navbar-brand" href="distributorHome.php"style="color:aliceblue ;">&nbsp;Roots</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <li class="nav-item">
                <a class="nav-link active" style="color:aliceblue ;" aria-current="page" href="distributorHome.php">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link test-center" style="color:aliceblue ;" href="logout.php" style="color: red">logout</a>
                </li>
            </ul>
        </div>
        </div>
    ...
    <div class="container d-flex justify-content-center"  style="color:aliceblue ;">
      <!-- <form action="d_inventory.php?did=<?php echo $dID?>" method="POST" style="width:50vw; min-width: 300px;">
        <div class="Container">
        ...
        <div class="d-flex justify-content-center">
          <button type="submit" class="btn mt-4" name="update" style="background-color:aliceblue;">Save</button>&nbsp;
          <a href="d_inventory.php" class="btn mt-4" style="background-color:aliceblue">Cancle</a>
        </div>
      </form> -->
    </div>
  </div>
  ...
  <div class="container mt-4">
    <table class="table table-light table-hover text-center">
      ...
      <tbody>
        ...
        $sql3 = "SELECT * FROM `distributor` WHERE id =$dID;";
        $result3 = mysqli_query($conn, $sql3);  
        while ($row = mysqli_fetch_assoc($result3)) { ?>
          <tr>
            <!-- <th><?php echo $row['d_sl']?></th> -->
            <th><?php echo $row['product_name']?></th>
            <th><?php echo $row['quantity']?></th>
            <th><?php echo $row['buing_price']?></th>
            <th><?php echo $row['selling_price']?></th>
            <th>
              <a class="btn btn-dark btn-sm" href="d_invUpdate.php?dsl= <?php echo $row['d_sl'] ?> & did=<?php echo $dID ?>" target="_blank"> update</a>
            </th>
          </tr>
        <?php
        }
