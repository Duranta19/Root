  ...
  <nav class="navbar navbar-expand-lg navbar-light" >
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="farmerHome.php" style="color: white">Home</a>
        </li>
        <li class="nav-item">
...
<div class="container mt-4">
    <table class="table table-hover table-light text-center">
      ...
      <?php
        ...
        $sql3 = "SELECT (SELECT name
                        FROM accounts
                        where accounts.id = d_id) as dist_name,p_name, ammount,tprice,t_id,f_id 
                from fsell_dbuy
                where f_id = $fID ;";
        ...
        ?>
        <tr>
            <th><?php echo $row['dist_name']?></th>
            <th><?php echo $row['p_name']?></th>
            <th><?php echo $row['ammount']?></th>
